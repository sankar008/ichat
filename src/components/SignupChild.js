            ...
            <div className="row h-100">
                ...
                <div className="col-12 col-lg-5 panRight">
                    <div className="panWrapper text-light form-theme">
                        ...
                        }
                        {
                          isField === 1?(
                            <>
                              ...
                              <div className="form-floating my-5">
                                <input type="text" className="form-control" id="lastName" name="lastName" placeholder="Enter your First name" onChange={handalerChanges}/>
                                <label htmlFor="u-name">Last Name</label>
                              </div>
                            </>
                          ):``
                        }{
                        ...
                        {
                          isField === 5?<><p>Show success message here</p></>:<>
